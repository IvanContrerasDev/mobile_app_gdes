      ...
      <ScrollView className="mt-8" showsVerticalScrollIndicator={false}>
        {Object.entries(groupedDocuments).map(([month, docs]) => (
          <View key={month} className="mb-6">
            <Text className="text-sm font-semibold text-[#0F172A] mb-3">{month}</Text>
          ...
          <View className="bg-white rounded-2xl w-full max-w-[340px] p-6">
            ...
            <View className="flex flex-col gap-4">
              ...
              <View className="flex flex-col gap-2">
                ...
                >
                  <AttachIcon size={16} color={fileAttached ? "#62882B" : "#0F172A"} />
                  <Text className={`text-sm font-medium ${fileAttached ? "text-[#62882B]" : "text-[#0F172A]"}`}>
              ...
              <View className="flex flex-row gap-3 mt-2">
                ...
                <Pressable
                  ...
                  className={`flex-1 h-12 rounded-xl items-center justify-center ${
                    canUpload ? "bg-[#0D80AE]" : "bg-gray-200"
                  }`}
                >
                  <Text className={`text-sm font-semibold ${canUpload ? "text-white" : "text-gray-400"}`}>
                    Subir documento
                  </Text>
                </Pressable>
              </View>
